...
IMG_BASE64="iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mP8/x8AAwMCAO5WZ4kAAAAASUVORK5CYII="
...
PROMPT=$(yes "describe" | head -n "${TOKENS}" | tr '\n' ' ')

curl \
  --noproxy '*' \
  -s \
  -o /tmp/mm_resp_${ID}.json \
...
echo
echo "===================================================="
echo "Starting image stress test"
echo "===================================================="
...
echo
echo "===================================================="
echo "Image stress test complete"
echo "Total requests sent: ${REQUEST_COUNT}"
echo "===================================================="
